...
object PepperHeadCamera {

    val matrix = hashMapOf<Pair<Int, Int>, DoubleArray>(
    ...
    val distortionCoefs = doubleArrayOf(
        -8.55109544e+00,
        -1.33329352e+02,
        -1.85792215e-03,
        4.06427067e-03,
    ...
    // There is now way to obtain position of the camera programmatically in Android.
    ...
    val gazeToCameraTransform = Transform(
