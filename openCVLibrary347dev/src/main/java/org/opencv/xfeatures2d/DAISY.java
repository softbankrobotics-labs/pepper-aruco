...
public class DAISY extends Feature2D {
    ...
    public static DAISY create(float radius, int q_radius, int q_theta, int q_hist, int norm, Mat H, boolean interpolation, boolean use_orientation) {
        return DAISY.__fromPtr__(create_0(radius, q_radius, q_theta, q_hist, norm, H.nativeObj, interpolation, use_orientation));
    }

    public static DAISY create(float radius, int q_radius, int q_theta, int q_hist, int norm, Mat H, boolean interpolation) {
        return DAISY.__fromPtr__(create_1(radius, q_radius, q_theta, q_hist, norm, H.nativeObj, interpolation));
    }

    public static DAISY create(float radius, int q_radius, int q_theta, int q_hist, int norm, Mat H) {
        return DAISY.__fromPtr__(create_2(radius, q_radius, q_theta, q_hist, norm, H.nativeObj));
    }

    public static DAISY create(float radius, int q_radius, int q_theta, int q_hist, int norm) {
        return DAISY.__fromPtr__(create_3(radius, q_radius, q_theta, q_hist, norm));
    }

    public static DAISY create(float radius, int q_radius, int q_theta, int q_hist) {
        return DAISY.__fromPtr__(create_4(radius, q_radius, q_theta, q_hist));
    }
    ...
    private static native long create_1(float radius, int q_radius, int q_theta, int q_hist, int norm, long H_nativeObj, boolean interpolation);
    private static native long create_2(float radius, int q_radius, int q_theta, int q_hist, int norm, long H_nativeObj);
    private static native long create_3(float radius, int q_radius, int q_theta, int q_hist, int norm);
    private static native long create_4(float radius, int q_radius, int q_theta, int q_hist);
